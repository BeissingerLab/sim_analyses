...
##Read genotypes
```{r}
genos <- read.csv("all_sim_data/simulation_analyses_0.8/IBM_sample_final1.csv",header=T,stringsAsFactors=F,na.strings=c("-","NA"))
```
...
```{r}
  setwd("all_sim_data/simulation_analyses_her0.8")
write.csv(tworesults, file = paste("results.epistatic.0.8.csv"))

write.csv(results, file = paste("results.additive.0.8.csv"))
```
