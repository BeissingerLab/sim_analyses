...
##Read genotypes
```{r}
genos <- read.csv("all_sim_data/simulation_analyses_0.9/IBM_sample_final1.csv",header=T,stringsAsFactors=F,na.strings=c("-","NA"))
```
...
```{r}
  setwd("all_sim_data/simulation_analyses_her0.9")
