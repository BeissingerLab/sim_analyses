...
##Read genotypes
```{r}
genos <- read.csv("all_sim_data/simulation_analyses_0.7/IBM_sample_final1.csv",header=T,stringsAsFactors=F,na.strings=c("-","NA"))
```
...
```{r}
  setwd("all_sim_data/simulation_analyses_her0.7")
write.csv(tworesults, file = paste("results.epistatic.0.7.csv"))

write.csv(results, file = paste("results.additive.0.7.csv"))
```
