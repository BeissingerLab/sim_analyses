...
##Read genotypes
```{r}
genos <- read.csv("all_sim_data/simulation_analyses_0.3/IBM_sample_final1.csv",header=T,stringsAsFactors=F,na.strings=c("-","NA"))
```
...
```{r}
  setwd("all_sim_data/simulation_analyses_her0.3")
write.csv(tworesults, file = paste("results.epistatic.0.3.csv"))

write.csv(results, file = paste("results.additive.0.3.csv"))
```
