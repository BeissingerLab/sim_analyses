...
##Read genotypes
```{r}
genos <- read.csv("all_sim_data/simulation_analyses_0.4/IBM_sample_final1.csv",header=T,stringsAsFactors=F,na.strings=c("-","NA"))
```
...
```{r}
  setwd("all_sim_data/simulation_analyses_her0.4")
write.csv(tworesults, file = paste("results.epistatic.0.4.csv"))

write.csv(results, file = paste("results.additive.0.4.csv"))
```
