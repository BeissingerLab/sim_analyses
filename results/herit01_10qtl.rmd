...
```{r}
allSims <- read.table(file = "all_sim_data/IBM_10_QTN_h.2_0.1_epis.eff_0.6_reps_100/simulation_data/Simulated.Data.100.Reps.Herit.0.1.txt",header=T,stringsAsFactors=F)
```
...
```{r}
setwd("all_sim_data/IBM_10_QTN_h.2_0.1_epis.eff_0.6_reps_100")
twosigs <- read.table(file = "Genotypic.information.for.10.Epistatic.QTN.txt",stringsAsFactors=F,header=T, sep = "\t")[,1]
...
write.csv(tworesults, file = paste("results.epistatic.0.1_10qtl.csv"))
```
